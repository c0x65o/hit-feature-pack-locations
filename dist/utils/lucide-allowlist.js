 ...
 */
'use client';
import { Building2, MapPin, Users, User, Tag, Layers, LayoutDashboard, Settings, Shield, ShieldCheck, FolderKanban, FileText, Clock, Calendar, TrendingUp, Link2, ChevronDown, ChevronLeft, ChevronRight, Activity, CheckCircle, Cog, Wrench, } from 'lucide-react';
const ICONS = {
    Activity,
    Building2,
    Calendar,
...
export function resolveLucideIconStrict(name) {
    ...
    if (!Icon) {
        throw new Error(`[hit-feature-pack-locations] Unknown Lucide icon "${name}" (normalized: "${key}"). ` +
